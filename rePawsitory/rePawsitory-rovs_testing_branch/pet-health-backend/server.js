...
// CORS configuration
// Allow multiple origins including localhost and your deployed frontend
const allowedOrigins = [
  'http://localhost:3000',
  'http://localhost:3001',
  process.env.FRONTEND_URL // Add your frontend URL in Render environment variables
...
app.use(cors({
  origin: function(origin, callback) {
    ...
    if (allowedOrigins.indexOf(origin) !== -1) {
      ...
      callback(null, true); // For now, allow all origins. Change to false for production security
    }
  },
  credentials: true,
